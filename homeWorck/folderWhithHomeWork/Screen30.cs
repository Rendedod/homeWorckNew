...
{
    public partial class Screen30 : UserControl
    {
        // Внешние переменные:
        ...
        private void Screen30_Load(object sender, EventArgs e)
        {
        ...
        void НачалоТеста()
        {
            var Кодировка = Encoding.UTF8;
            try
            {
                // Создание экземпляра StreamReader для чтения из файла
                Читатель = new System.IO.StreamReader( @"C:\myCode\myC#Code\homeWorck\homeWorck\textFile\Text Document30.txt", Кодировка);
